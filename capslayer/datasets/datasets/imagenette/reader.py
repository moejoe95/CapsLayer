...
def parse_fun(serialized_example):
    ...
    return {
        'images': tf.cast(image, tf.float32) / 255., 
...
class DataLoader(object):
    ...
    def __init__(self, path,
        ...
        ds = tfds.load(DS_NAME, split='train', shuffle_files=True, data_dir=base_path, batch_size=cfg.batch_size)
    ...
    def __call__(self, batch_size, mode):
        ...
        with tf.name_scope(self.name):
            ...
            # data pipeline
            # https://www.tensorflow.org/datasets/keras_example?hl=en
